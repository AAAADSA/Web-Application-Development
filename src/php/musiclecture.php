...
<head>
    ...
    <title>MMS Music Lecuture</title>
</head>
<body>
    <div class="container">
        <div class="eventh2">
        ...
        <div class="gaminge1">
            <img src="../image/musiclecture.jpg" alt="<?php echo $event['EventName']; ?>">
        </div>
       
        <div class="event">
            <p>
                <ul>
                    <li>Unlock the Secrets of Music: Attend Our Exclusive Music Lecture!</li>
                    <li>Reserve your seat now and join us for an unforgettable exploration of music's timeless beauty and profound significance.</li>
                    <li>Take the first step towards a deeper appreciation of music and reserve your spot today!</li>
                </ul>      
            </p>
        </div>
