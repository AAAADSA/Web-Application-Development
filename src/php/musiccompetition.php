...
<head>
    ...
    <title>MMS Music Competition</title>
</head>
<body>
    <div class="container">
        <div class="eventh2">
        ...
        <div class="gaminge1">
            <img src="../image/musiccompetition.jpg" alt="<?php echo $event['EventName']; ?>">
        </div>
       
        <div class="event">
            <p>
                <ul>
                     <li>Step into the Spotlight: Join Our Music Competition!</li>
                    <li>Calling all talented musicians and performers! It's time to showcase your skills and shine on stage at our prestigious music competition. </li>
                    <li>. Let your talent take center stage and show the world what you're made of!</li>
                </ul>       
            </p>
        </div>
