...
<body>
    <div class="container">
        ...
        <div class="gaminge1">
            <img src="../image/MMSRUN.png" alt="<?php echo $event['EventName']; ?>">
        </div>
       
        <div class="event">
              <p>
                <ul> <li>Join Us and Experience the Music Run!</li> <li>Music Run invites you to join this unique music-themed running extravaganza!</li> <li>Music Run is an extraordinary running event that combines music, fitness, and fun. Here, you'll experience an unprecedented running adventure, challenging yourself while grooving to the beats of energetic music!</li> </ul>    
            </p>
        </div>
